        ...
        <div
            ...
            <div className={`${styles.flexCenter} flex-col bg-primary w-[100%] h-[100%] rounded-full`}>
                <div className={`${styles.flexStart} flex-row`}>
                    ...
                    <p className={`${lang? 'hidden' : 'block'} font - poppins font-medium text-[18px] leading-[23px] mr-2`}>
                ...
                <p className={`${lang? 'hidden' : 'block'} font - poppins font-medium text-[18px] leading-[23px]`}>
